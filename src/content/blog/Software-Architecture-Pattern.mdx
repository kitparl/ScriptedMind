...
pubDate: 2024-10-04T18:30:00.000Z
draft: false
tags:
  - Technology
  - Software
...
If you don't follow any architecture, your code can become a mess, like a _big ball of mud_, where everything is tangled. When one part of the system is changed, it can break other parts. Tools like Hex-Ray can help detect this problem.
...
- [Monolithic Architecture Pattern (click)](https://blogs.bhosdike.tech/post/software-architecture-pattern/monolithic-architecture-pattern/)
