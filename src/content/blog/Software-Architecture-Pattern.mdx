...
**1. [Layered Architecture Pattern (click 👆)](https://pranshu.tech/post/software-architecture-pattern/layered-architecture-pattern/)**

**2. [Monolithic Architecture Pattern (click 👆)](https://pranshu.tech/post/software-architecture-pattern/monolithic-architecture-pattern/)**

**3. [Microservices Architecture Pattern (click 👆)](https://pranshu.tech/post/software-architecture-pattern/microservices-architecture-pattern/)**

**4. [Event-Driven Architecture Pattern (click 👆)](https://pranshu.tech/post/post/software-architecture-pattern/event-driven-architecture-pattern/)**

![](../../assets/images/infomation/types-of-archetecture.png)

**5. [Microkernel Architecture Pattern (click 👆)](https://pranshu.tech/post/software-architecture-pattern/microkernel-architecture-pattern/)**
