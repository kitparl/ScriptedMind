...
description: The two-pointer technique is frequently applied to effectively solve array problems. It is a search method that compares elements referenced by two pointers and updates them as necessary to solve problems involving collections such as arrays and lists.
pubDate: 2022-06-24T18:30:00.000Z
tags:
  - algo
  - dsa
...
**1.** Opposite Ends (start and endss)
