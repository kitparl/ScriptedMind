...
- [Software Architecture Pattern (click)](https://blogs.bhosdike.tech/post/Software-Architecture-Pattern/)

![](../../../assets/images/infomation/types-of-archetecture.png)

- [Layered Architecture Pattern (click)](https://blogs.bhosdike.tech/post/software-architecture-pattern/layered-architecture-pattern/)
- [Microservices Architecture Pattern (click)](https://blogs.bhosdike.tech/post/software-architecture-pattern/microservices-architecture-pattern/)
- [Event-Driven Architecture Pattern (click)](https://blogs.bhosdike.tech/post/software-architecture-pattern/event-driven-architecture-pattern/)
- [Microkernel Architecture Pattern (click)](https://blogs.bhosdike.tech/post/software-architecture-pattern/microkernel-architecture-pattern/)
